...
//   ifrm.setAttribute("src", "https://www.youtube.com/watch?v=5u4xTa3LR2U");
...
function reveal() {
  ...
  var ifrm = document.createElement("iframe");
  // Thay thế URL với URL embed và thêm tham số autoplay=1
  ifrm.setAttribute("src", "https://www.youtube.com/embed/5u4xTa3LR2U?autoplay=1");
  ifrm.style.width = `${w}px`;
  ifrm.style.height = `${h}px`;
  ifrm.style.border = 'none';
